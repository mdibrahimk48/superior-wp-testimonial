...
function spwptm_enqueue_styles() {
	...
	wp_enqueue_style( 'spwptm-style', plugins_url( 'css/spwptm-style.css', __FILE__) );
}
...
function spwptm_enqueue_scripts() {
	...
	wp_enqueue_script( 'spwptm-script', plugins_url( 'js/spwptm-scripts.js', __FILE__), array(), '1.0.0', true );
}
				...
				<div class="testimonial">
					...
					<div class="testimonial-content">
						<div class="testimonial-profile">
							<h3 class="name"><?php echo get_post_meta( get_the_ID(), '_spwptm_testi_name', true ); ?></h3>
							<span class="post"><?php echo get_post_meta( get_the_ID(), '_spwptm_testi_desig', true ); ?></span>
						</div>
						<ul class="rating">

							<?php
							//rating print
								$spwptm_client_review = get_post_meta( get_the_ID(), '_spwptm_rating', true);
